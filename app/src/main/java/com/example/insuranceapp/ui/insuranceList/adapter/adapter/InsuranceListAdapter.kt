package com.example.insuranceapp.ui.insuranceList.adapter.adapter
...
class InsuranceListAdapter(items: ArrayList<Master>, activity: Context, insuranceName: String) :
    ...
    override fun onBindViewHolder(p0: ViewHolder, p1: Int) {
        ...
        p0.block.text = masterModel?.BlockCode
        p0.village.text = masterModel?.VillageCode
        p0.contactNo.text = masterModel?.Phno_ofNominee
        p0.nomineeName.text = masterModel?.Name
        p0.bankbranch.text = masterModel?.Name
    ...
    inner class ViewHolder(mView: View) : RecyclerView.ViewHolder(mView) {
        ...
        var actionButton: Button = mView.findViewById(R.id.moreInfoUp)
