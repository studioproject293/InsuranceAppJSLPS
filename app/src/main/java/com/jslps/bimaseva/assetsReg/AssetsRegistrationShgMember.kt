...
class AssetsRegistrationShgMember : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "SHG Claim Registration Of Asset"
        ...
        buttonSave?.setOnClickListener {
            if (name?.text.toString().isEmpty()) {
                ...
                if (DialogUtil.isConnectionAvailable(this@AssetsRegistrationShgMember)) {
                    DialogUtil.displayProgress(this@AssetsRegistrationShgMember)
                    ...
                    createInsurance.enqueue(object : Callback<String> {
                        override fun onResponse(
                            ...
                            Sneaker.with(this@AssetsRegistrationShgMember) // Activity, Fragment or ViewGroup
                                ...
                                .sneakSuccess()
                            val intent = Intent(
                                this@AssetsRegistrationShgMember,
        ...
        radioGroup?.setOnCheckedChangeListener(
            RadioGroup.OnCheckedChangeListener { group, checkedId ->
                ...
                if (radiovalue.equals("SHG")) {
                    ...
                    instituionType = 2
                    spinnerPg?.setText("")
                    getPGDataList(villageCode.toString())
    ...
    private fun setId() {
        ...
        pgLayout = findViewById(R.id.pg)
        shgLayout = findViewById(R.id.SHG)
        ...
        spinnerPg = findViewById<AutoCompleteTextView>(R.id.spinnerPg)
