...
import kotlinx.android.synthetic.main.insurace_details_underprocess_assert.*
import java.io.*
...
class ClaimSetteledDetailsFragment : BaseFragment(), ClaimSetteledDetailsView,
    ...
    var doucment_previous_underprocess: ImageView? = null
    var doucment_previous_deathImage: ImageView? = null
    var doucment_previous_panchnamaImage: ImageView? = null
    var doucment_previous_postmortemImage: ImageView? = null
    var doucment_previous_TagImage: ImageView? = null
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(R.layout.claim_details_assert, container, false)
        ...
        doucment_previous_underprocess =
            rootView?.findViewById<ImageView>(R.id.doucment_previous_underprocess)
        doucment_previous_TagImage =
            rootView?.findViewById<ImageView>(R.id.doucment_previous_TagImage)
        doucment_previous_panchnamaImage =
            rootView?.findViewById<ImageView>(R.id.doucment_previous_panchnamaImage)
        doucment_previous_postmortemImage =
            rootView?.findViewById<ImageView>(R.id.doucment_previous_postmortemImage)
        doucment_previous_deathImage =
            rootView?.findViewById<ImageView>(R.id.doucment_previous_deathImage)
        ...
        try {
            val byteArrayDeathImage: ByteArray =
                Base64.decode(insuranceNameeee?.Death_image, 0)
            val bitmapDeathImage = BitmapFactory.decodeByteArray(byteArrayDeathImage, 0, byteArrayDeathImage.size)
            doucment_previous_deathImage?.setImageBitmap(bitmapDeathImage)
            val byteArrayPostmOrtom: ByteArray =
                Base64.decode(insuranceNameeee?.Postmortem_image, 0)
            val bitmapPostmortom = BitmapFactory.decodeByteArray(byteArrayPostmOrtom, 0, byteArrayPostmOrtom.size)
            doucment_previous_postmortemImage?.setImageBitmap(bitmapPostmortom)
        } catch (e: Exception) {
            e.printStackTrace()
        } catch (e: java.lang.Error) {
        }
        val byteArray1Up: ByteArray =
            Base64.decode(insuranceNameeee?.image_UP, 0)
        val bitmapUp = BitmapFactory.decodeByteArray(byteArray1Up, 0, byteArray1Up.size)
        doucment_previous_underprocess?.setImageBitmap(bitmapUp)
        try {
            val byteArray: ByteArray =
                Base64.decode(insuranceNameeee?.Tag_image, 0)
            val bitmap = BitmapFactory.decodeByteArray(byteArray, 0, byteArray.size)
            doucment_previous_TagImage?.setImageBitmap(bitmap)
            val byteArraypanchnamaImage: ByteArray =
                Base64.decode(insuranceNameeee?.Panchnama_image, 0)
            val bitmappanchnamaImage = BitmapFactory.decodeByteArray(byteArraypanchnamaImage, 0, byteArraypanchnamaImage.size)
            doucment_previous_panchnamaImage?.setImageBitmap(bitmappanchnamaImage)
        } catch (e: Exception) {
            e.printStackTrace()
        } catch (e: java.lang.Error) {
        }
