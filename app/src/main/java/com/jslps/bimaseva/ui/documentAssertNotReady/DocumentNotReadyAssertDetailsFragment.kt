...
class DocumentNotReadyAssertDetailsFragment : BaseFragment(), DocumentNotReadyAssertView, OnFragmentListItemSelectListener {
    ...
    companion object {
        ...
        fun getInstance(insuranceNamee: Master): DocumentNotReadyAssertDetailsFragment {
            insuranceNameeee = insuranceNamee
            return DocumentNotReadyAssertDetailsFragment()
        }
    }
}
