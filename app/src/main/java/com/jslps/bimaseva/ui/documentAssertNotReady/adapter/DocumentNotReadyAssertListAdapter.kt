package com.jslps.bimaseva.ui.documentAssertNotReady.adapter
...
class DocumentNotReadyAssertListAdapter(items: ArrayList<Master>, activity: Context, insuranceName: String) :
    RecyclerView.Adapter<DocumentNotReadyAssertListAdapter.ViewHolder>() {
