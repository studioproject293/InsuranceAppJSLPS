package com.jslps.bimaseva.ui.documentFalseAssert.adapter
...
class DocumentFalseListAdapter(items: ArrayList<Master>, activity: Context, insuranceName: String) :
    RecyclerView.Adapter<DocumentFalseListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(p0: ViewHolder, p1: Int) {
        ...
        p0.contactNo.text = masterModel?.phno_ofNominee.toString()
