...
import com.jslps.bimaseva.ui.insuranceListAssertInsurance.adapter.InsuranceListAdapter

class InsuranceListAssertFragment : BaseFragment(), InsuranceAssertView, OnFragmentListItemSelectListener {
    ...
    companion object {
        ...
        fun getInstance(insuranceNamee: List<Master>): InsuranceListAssertFragment {
            insuranceName = insuranceNamee
            return InsuranceListAssertFragment()
        }
    }
}
