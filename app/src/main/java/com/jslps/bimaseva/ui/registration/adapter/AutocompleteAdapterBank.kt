...
import com.jslps.bimaseva.model.districtModel.DistrictMasterClass
 ...
 class AutocompleteAdapterBank(
     context: Context, @LayoutRes private val layoutResource: Int,
     private var listItemsTxt: List<Table6Db>,
     s: String
 ):
    ArrayAdapter<Table6Db>(context, layoutResource, listItemsTxt),
    Filterable {
    private val mInflater: LayoutInflater = LayoutInflater.from(context)
    private var mPois: List<Table6Db> = listItemsTxt
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (convertView == null) {
            ...
            vh = view.tag as ItemRowHolder
                ...
                val districtMasterClass = mPois as ArrayList<Table6Db>
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            override fun publishResults(
                ...
                mPois = filterResults.values as List<Table6Db>
    ...
    private class ItemRowHolder(row: View?) {
     ...
     override fun getItem(position: Int): Table6Db? {
