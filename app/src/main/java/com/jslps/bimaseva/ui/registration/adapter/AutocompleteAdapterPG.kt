...
class AutocompleteAdapterPG(
     context: Context, @LayoutRes private val layoutResource: Int,
     private var listItemsTxt: List<Table7Db>,
     s: String
 ):
    ArrayAdapter<Table7Db>(context, layoutResource, listItemsTxt),
    Filterable {
    private val mInflater: LayoutInflater = LayoutInflater.from(context)
    private var mPois: List<Table7Db> = listItemsTxt
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (convertView == null) {
            ...
            vh = view.tag as ItemRowHolder
                ...
                val districtMasterClass = mPois as ArrayList<Table7Db>
                vh.label.text = districtMasterClass.get(position).pgname
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            override fun publishResults(
                ...
                mPois = filterResults.values as List<Table7Db>
            ...
            override fun performFiltering(charSequence: CharSequence?): Filter.FilterResults {
                ...
                filterResults.values = if (queryString == null || queryString.isEmpty())
                    ...
                    listItemsTxt.filter {
                                it.pgname?.toLowerCase()!!.contains(queryString)
    ...
    private class ItemRowHolder(row: View?) {
     ...
     override fun getItem(position: Int): Table7Db? {
