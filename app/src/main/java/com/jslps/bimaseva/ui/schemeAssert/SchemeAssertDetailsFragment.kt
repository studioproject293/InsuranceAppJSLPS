...
import com.jslps.bimaseva.ui.schemeAssert.adapter.SchemeAssertListAdapter

class SchemeAssertDetailsFragment : BaseFragment(), SchemeDetailsAssertView, OnFragmentListItemSelectListener {
    override fun showMessage(message: String) {
        val toast = Toast.makeText(activity, message, Toast.LENGTH_SHORT)
        toast.show()
    }

    var homeRecyclerviewAdapter: SchemeAssertListAdapter? = null
        ...
        if (cardInitResponse != null) {
            ...
            if (homeRecyclerviewAdapter == null)
                homeRecyclerviewAdapter =
                    SchemeAssertListAdapter(cardInitResponse, activity as Activity, insuranceName!!)
            else
    ...
    var presenter: SchemeAssertDetailsPresenter? = null
    ...
    override fun onCreateView(
        ...
        presenter = SchemeAssertDetailsPresenter(this, activity as Activity)
    ...
    companion object {
        ...
        fun getInstance(insuranceNamee: String): SchemeAssertDetailsFragment {
            insuranceName = insuranceNamee
            return SchemeAssertDetailsFragment()
        }
    }
}
