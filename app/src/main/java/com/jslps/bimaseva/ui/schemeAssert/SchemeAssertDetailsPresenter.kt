...
class SchemeAssertDetailsPresenter(view: SchemeDetailsAssertView, context: Activity) : BasePresenter,
    Presenter(),
        ...
        when (itemId) {
            ...
            2 -> {
                ...
                changePhotoResponseModelCall.enqueue(object : Callback<String> {
                    ...
                    override fun onFailure(call: Call<String>, t: Throwable) {
                        DialogUtil.stopProgressDisplay()
                        val toast = Toast.makeText(context, "Server Error,Please Try again", Toast.LENGTH_SHORT)
                        toast.show()
                    }
                })
            }
            3 -> {
                ...
                val changePhotoResponseModelCall =
                    apiServices.getTabletDownloadDataBCsakhi(
                        "cs", "", getAppCache().insuranceStepSend!!,
                        arraylistPanchyat.get(0).blockcode!!
                    )
                changePhotoResponseModelCall.enqueue(object : Callback<String> {
                    override fun onResponse(call: Call<String>, response: Response<String>) {
    ...
    var view: SchemeDetailsAssertView? = view
