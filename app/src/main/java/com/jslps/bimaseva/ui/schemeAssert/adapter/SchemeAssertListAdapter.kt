package com.jslps.bimaseva.ui.schemeAssert.adapter
...
class SchemeAssertListAdapter(items: ArrayList<String>, activity: Context, insuranceName: String) :
    RecyclerView.Adapter<SchemeAssertListAdapter.ViewHolder>() {

    var itemList: ArrayList<String>? = items
    var context: Context? = activity
    var insuranceName: String = insuranceName
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): SchemeAssertListAdapter.ViewHolder {
